...
class Migration(migrations.Migration):
    ...
    operations = [migrations.CreateModel(name='ArticleTags',
        ...
        migrations.CreateModel(name='Tag',
            fields=[('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=256, verbose_name='Название')), ('products',
                                                                                       models.ManyToManyField(
                                                                                           related_name='orders',
                                                                                           through='articles.ArticleTags',
                                                                                           to='articles.Article')), ], ),
        migrations.AddField(model_name='articletags', name='tag',
